...
public class BasePage {
	...
	/*
	 * for example: xpath=//input[@class='%s'] , values=Manager => result: xpath=//input[@class='Manager']
	 */
	...
	protected void waitForAllElementsVisible(WebDriver driver, String locatorType, String... dynamicValues) {
		WebDriverWait explicitWait = new WebDriverWait(driver, GlobalConstants.LONG_TIMEOUT);
		explicitWait
				.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(getByLocator(generateDynamicXpath(locatorType, dynamicValues))));
	}
	...
	protected void waitForAllElementsInvisible(WebDriver driver, String locatorType, String... dynamicValues) {
		WebDriverWait explicitWait = new WebDriverWait(driver, GlobalConstants.LONG_TIMEOUT);
		explicitWait.until(
				ExpectedConditions.invisibilityOfAllElements(getListWebElement(driver, generateDynamicXpath(locatorType, dynamicValues))));
	}
	...
	protected void waitForElementPresence(WebDriver driver, String locatorType, String... dynamicValues) {
		WebDriverWait explicitWait = new WebDriverWait(driver, GlobalConstants.LONG_TIMEOUT);
		explicitWait
				.until(ExpectedConditions.presenceOfAllElementsLocatedBy(getByLocator(generateDynamicXpath(locatorType, dynamicValues))));
	}
